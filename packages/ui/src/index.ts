...
export type { ShowDialogOptions, DialogSize, DialogInstance } from './components/dialog/functional'
...
export type { MessageBoxOptions, MessageBoxResult, MessageBoxAction, MessageBoxType } from './components/message-box/functional'
