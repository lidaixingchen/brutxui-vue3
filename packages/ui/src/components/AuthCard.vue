    ...
    <Card :class="rootClasses" variant="default">
        ...
        <CardContent>
            ...
            <div class="relative mb-6">
                <div class="absolute inset-0 flex items-center"><div class="w-full border-t-3 border-brutal" /></div>
            ...
            <form class="space-y-4" @submit.prevent="handleSubmit">
                <div class="space-y-2">
                    <LabelRoot for="email">Email</LabelRoot>
                    <div class="relative">
                ...
                <div class="space-y-2">
                    <div class="flex items-center justify-between">
                        <LabelRoot for="password">Password</LabelRoot>
                        <button type="button" class="text-sm font-bold text-brutal-primary" @click="emit('forgotPassword')">Forgot password?</button>
                    </div>
                    <div class="relative">
