...
<template>
    <div :class="wrapperClasses">
        <svg xmlns="http://www.w3.org/2000/svg" class="size-5 shrink-0 stroke-[3] text-black" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
