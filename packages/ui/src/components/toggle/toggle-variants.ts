...
import { brutalHoverLiftSmStateOff, brutalPress, brutalPressedStateOn } from '@/lib/brutal-interaction-variants'
        ...
        variants: {
            variant: {
                default: [
                    ...
                    `data-[state=off]:hover:bg-brutal-muted ${brutalHoverLiftSmStateOff}`,
