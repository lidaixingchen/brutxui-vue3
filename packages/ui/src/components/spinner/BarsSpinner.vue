...
import { barsSpinnerVariants, getSpinnerColorClasses, type SpinnerColor } from './spinner-variants'
...
const BAR_COUNT = BAR_HEIGHT_RATIOS.length

const containerClasses = computed(() =>
    cn(barsSpinnerVariants({ size: props.size }), props.class)
)

const barWidthMap: Record<BarsSpinnerSize, string> = {
    sm: 'w-1',
    default: 'w-1.5',
    lg: 'w-2',
    xl: 'w-3',
