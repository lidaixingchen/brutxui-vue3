...
{{ resolvedTitle }}
        ...
        <CardContent>
            <div class="grid grid-cols-2 gap-3 mb-6">
                <Button variant="outline" class="w-full" :disabled="submitting" @click="emit('google-click')">
                ...
                <Button variant="outline" class="w-full" :disabled="submitting" @click="emit('github-click')">
...
{{ resolvedPassword }}
                        ...
                        <Button type="button" variant="link" class="text-sm font-bold text-brutal-primary" @click="emit('forgot-password')">
...
{{ resolvedSignIn }}
        ...
        <CardFooter class="justify-center">
            <p class="text-sm font-medium text-brutal-muted-foreground">
                {{ resolvedNoAccount }}
                <Button type="button" variant="link" class="font-bold text-brutal-primary" @click="emit('register-click')">
                    {{ resolvedRegister }}
                </Button>
            </p>
        </CardFooter>
