...
/**
 * 默认 registry 源：GitHub Release 资产，扁平命名，无目录层级。
 * 默认源为单元素数组（多源 fallback 引擎退化为单源尝试，可靠性由 GitHub 可用性兜底）。
 ...
 * 单源快捷别名，新代码优先使用 DEFAULT_REGISTRY_SOURCES。
 */
