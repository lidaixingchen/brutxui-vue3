...
export const COMPONENT_FILES: Record<string, ComponentFileMapping> = {
    ...
    cascader: { files: ['Cascader.vue', 'cascader-variants.ts', 'cascader-types.ts', 'index.ts'], composables: ['useLocale.ts', 'useClearable.ts', 'useClearableSelection.ts', 'useSelectableTrigger.ts', 'useSelectionDisplayText.ts'] },
    checkbox: { files: ['Checkbox.vue', 'checkbox-variants.ts'] },
    combobox: { files: ['Combobox.vue', 'combobox-types.ts', 'combobox-variants.ts'], composables: ['useLocale.ts', 'useSelectableTrigger.ts', 'useSelectionDisplayText.ts'] },
    ...
    tabs: { files: ['TabsContent.vue', 'TabsList.vue', 'TabsTrigger.vue', 'tabs-variants.ts', 'types.ts'], composables: ['useLocale.ts'] },
    ...
    'tree-select': {
        ...
        composables: ['useLocale.ts', 'useClearable.ts', 'useClearableSelection.ts', 'useSelectableTrigger.ts', 'useSelectionDisplayText.ts'],
    },
    'typewriter-text': {
    ...
    'glitch-button': {
        files: ['GlitchButton.vue'],
        composables: ['useGlitchEffect.ts'],
    },
    'virtual-scroll': {
