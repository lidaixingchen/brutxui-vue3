...
> 本文档是 `docs/` 目录的索引，也是文档治理规则的落点——规则由《[文档目录改造方案](archive/2026/文档目录改造方案.md)》提炼并在此固化（该方案已完成并归档），维护 `docs/` 时无需回翻归档。
...
> 以下规则源自已归档的《文档目录改造方案》，在此固化；新增 / 维护文档时直接依此执行。
...
- **guides/ 豁免**：规范与操作手册保持英文 kebab-case 命名与英文标题，不改名。
