...
- **文件**：[packages/shared/src/component-files.ts](../../packages/shared/src/component-files.ts#L38) L38
- **类别**：数据一致性 / 注册表逻辑
...
- **文件**：[packages/shared/src/component-files.ts](../../packages/shared/src/component-files.ts#L30) L30
...
- **文件**：[packages/shared/src/component-files.ts](../../packages/shared/src/component-files.ts#L41) L41
- **类别**：数据一致性 / 注册表逻辑 / 跨包一致性
...
- **文件**：[packages/shared/src/component-files.ts](../../packages/shared/src/component-files.ts#L67) L67
- **类别**：数据一致性 / 注册表逻辑
...
- **文件**：[packages/cli/src/lib/services/diff-service.ts](../../packages/cli/src/lib/services/diff-service.ts#L19-L25) L19-L25
- **类别**：逻辑错误
...
- **文件**：[packages/cli/src/commands/add.ts](../../packages/cli/src/commands/add.ts#L278-L284) L278-L284
- **类别**：逻辑错误
...
- **文件**：[packages/cli/src/commands/create.ts](../../packages/cli/src/commands/create.ts#L68-L100) L68-L100
- **类别**：安全
...
- **文件**：[packages/cli/src/lib/services/init-service.ts](../../packages/cli/src/lib/services/init-service.ts#L205-L257) L205-L257
- **类别**：错误处理
...
- **文件**：[packages/cli/src/commands/add.ts](../../packages/cli/src/commands/add.ts#L47-L62) L47-L62（调用点 L161）
- **类别**：用户输入校验
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L277-L280) L277-L280
- **类别**：构建逻辑
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L683-L694) L683-L694
- **类别**：构建逻辑
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L542-L655) L542-L655
- **类别**：构建逻辑
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L189-L240) L189-L240
- **类别**：逻辑错误
...
- **文件**：[packages/shared/src/component-registry.ts](../../packages/shared/src/component-registry.ts#L159-L181) L159-L181
- **类别**：数据一致性
...
- **文件**：[packages/shared/src/component-registry.ts](../../packages/shared/src/component-registry.ts#L98-L100) L98-L100
- **类别**：数据结构
...
- **文件**：[packages/cli/src/lib/installed-components.ts](../../packages/cli/src/lib/installed-components.ts#L28-L52) L28-L52
- **类别**：逻辑错误
...
- **文件**：[packages/cli/src/lib/services/remove-service.ts](../../packages/cli/src/lib/services/remove-service.ts#L294-L305) L294-L305（`countComponentFiles` L233-L247 同样问题）
- **类别**：逻辑错误
...
- **文件**：[packages/cli/src/lib/services/init-service.ts](../../packages/cli/src/lib/services/init-service.ts#L140-L145) L140-L145
- **类别**：逻辑错误
...
- **文件**：[packages/cli/src/commands/add.ts](../../packages/cli/src/commands/add.ts#L146-L148) L146-L148（`update.ts` L11-13 同样问题）
- **类别**：状态/副作用
...
- **文件**：[packages/cli/src/lib/services/init-service.ts](../../packages/cli/src/lib/services/init-service.ts#L93) L93
- **类别**：依赖配置
...
- **文件**：[packages/cli/src/commands/info.ts](../../packages/cli/src/commands/info.ts#L66-L78) L66-L78
- **类别**：逻辑错误
...
- **文件**：[packages/cli/src/commands/doctor.ts](../../packages/cli/src/commands/doctor.ts#L546-L554) L546-L554
- **类别**：逻辑错误
...
- **文件**：[packages/cli/src/lib/services/diff-service.ts](../../packages/cli/src/lib/services/diff-service.ts#L121-L125) L121-L125
- **类别**：错误处理
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L195-L206) L195-L206（`buildRegistryItem` L589-L608 同样问题）
- **类别**：构建逻辑
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L292-L294) L292-L294（`extractComponentFileDeps` L383-385 同样问题）
- **类别**：构建逻辑
...
- **文件**：[packages/registry/scripts/validate-utils.ts](../../packages/registry/scripts/validate-utils.ts#L393-L402) L393-L402
- **类别**：校验逻辑
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L76) L76 与 [packages/registry/scripts/validate-utils.ts](../../packages/registry/scripts/validate-utils.ts#L166) L166
- **类别**：校验逻辑
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L219-L234) L219, L234 vs L564, L592, L621
- **类别**：错误处理
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L299-L324) L299-L324
- **类别**：构建逻辑
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L251-L253) L251-L253
- **类别**：逻辑错误
...
- **文件**：[packages/registry/scripts/validate-utils.ts](../../packages/registry/scripts/validate-utils.ts#L365-L429) L365-L429
- **类别**：校验逻辑
...
- **文件**：[packages/registry/scripts/build-registry.ts](../../packages/registry/scripts/build-registry.ts#L39) L39（`buildRegistryItem` L616-617、`computeSourceHash` L232 同样问题）
- **类别**：构建逻辑
...
- **文件**：[packages/shared/src/component-registry.ts](../../packages/shared/src/component-registry.ts#L112-L120) L112-L120
- **类别**：数据结构
...
- **文件**：[packages/shared/src/sidebar-generator.ts](../../packages/shared/src/sidebar-generator.ts#L154-L165) L154-L165（`generateComponentsSidebar` L208-L224）
- **类别**：侧边栏生成 / 逻辑错误（潜在）
