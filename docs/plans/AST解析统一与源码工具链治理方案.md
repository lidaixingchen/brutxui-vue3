...
> 状态：**done**
> 日期：2026-09-08
> 关联文档：[AST 工程实践调研报告](../reports/2026-09-08-AST工程实践调研报告.md)、[AST 工具选型资料](../reports/2026-09-08-AST工具选型资料.md)、[CLI语法树解析升级与Monorepo工作区感知方案](CLI语法树解析升级与Monorepo工作区感知方案.md)、[注册表编译与AST静态转换管线模块化方案](注册表编译与AST静态转换管线模块化方案.md)
> 修订记录：2026-09-08 建立共享解析契约、源码转换边界、消费端迁移顺序与验收标准；2026-09-09 明确文档工具语义引擎路线、补齐编译与副作用依赖边界、加固构建产物隔离门禁。
