...
本方案是 [v2 方案](../../archive/2026/core/架构优化方案-v2.md) 的延续，而非替代。v2 的 P0/P1/P2 已几乎全部落地（含 SSR 治理、性能基准、exports 自动化、turbo/changeset、shamefullyHoist 移除、辅助包 v2 全 P0/P1 项等），v3 基于 v2 落地后的剩余张力，聚焦 ROI 最高的三个方向。
