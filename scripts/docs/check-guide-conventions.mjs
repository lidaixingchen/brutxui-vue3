 ...
 *   - v3 遗留类（R7 禁止）：ring-offset-background
 *   - outline-none（R7 元素级机制抑制焦点 outline 且无 forced-colors 恢复）：focus-visible:outline-none / focus:outline-none / focus-within:outline-none
