...
| [Input](/components/input) | 文本输入框，支持变体和尺寸 |
...
| [Select](/components/select) | 下拉选择框，支持子组件 |
| [Slider](/components/slider) | 滑块，支持 v-model |
| [Label](/components/label) | 表单字段标签 |
| [Form](/components/form) | 表单系统，集成 vee-validate |
...
| [Calendar](/components/calendar) | 日期选择器，支持范围模式 |
| [ColorPicker](/components/color-picker) | 颜色选择器，支持 HEX/RGB/HSL、透明度、预设与历史记录 |
| [DatePicker](/components/date-picker) | 日期选择器族，支持单日期/范围/日期时间/周/月/年选择 |
...
| 组件 | 说明 |
| --- | --- |
| [Dialog](/components/dialog) | 模态对话框，支持 header/footer/title/description |
...
| 组件 | 说明 |
| --- | --- |
| [ColorModeSwitcher](/guide/theme#colormodeswitcher-组件) | 颜色模式切换，支持 icon/button/select 三种显示模式 |
