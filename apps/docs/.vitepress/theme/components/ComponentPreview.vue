...
const containerClass = computed(() =>
    cn(
        'relative p-4 sm:p-8 flex min-h-[150px] sm:min-h-[200px] bg-brutal-muted border-3 border-brutal shadow-brutal overflow-x-auto transition-all duration-150 vp-raw',
        props.align === 'center'
