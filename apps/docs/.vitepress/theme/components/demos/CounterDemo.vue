    ...
    <div class="space-y-8">
        ...
        <div>
            ...
            <div class="flex flex-wrap items-center gap-6">
                <Counter :key="key" :to="9999" prefix="$" size="lg" :duration="2000" />
                <Counter :key="key" :to="52800" prefix="¥" size="lg" :duration="2000" />
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex flex-wrap items-center gap-6">
                <Counter :key="key" :to="1234567" separator="," size="lg" :duration="2000" />
                <Counter :key="key" :to="1234567" separator="." size="lg" :duration="2000" />
                <Counter :key="key" :to="1234567" separator="" size="lg" :duration="2000" />
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex flex-wrap items-center gap-6">
                <Counter :key="key" :from="100" :to="500" size="lg" :duration="2000" />
                <Counter :key="key" :from="1000" :to="0" size="lg" :duration="2000" />
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex flex-wrap items-end gap-6">
                <div class="flex flex-col items-center gap-1">
                    <Counter :key="key" :to="42" size="sm" :duration="2000" />
                    <span class="text-xs font-bold opacity-60">SM</span>
                </div>
                <div class="flex flex-col items-center gap-1">
                    <Counter :key="key" :to="42" size="md" :duration="2000" />
                    <span class="text-xs font-bold opacity-60">MD</span>
                </div>
                <div class="flex flex-col items-center gap-1">
                    <Counter :key="key" :to="42" size="lg" :duration="2000" />
                    <span class="text-xs font-bold opacity-60">LG</span>
                </div>
                <div class="flex flex-col items-center gap-1">
                    <Counter :key="key" :to="42" size="xl" :duration="2000" />
        ...
        <div>
            ...
            <div class="flex flex-col items-start gap-2">
                <Counter :key="key" :to="100" size="lg" :duration="2000" @complete="onComplete" />
