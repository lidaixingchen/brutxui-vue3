...
<template>
    <div class="space-y-6 w-full">
        <div class="space-y-2">
            <p class="text-sm font-bold tracking-wide">基础用法</p>
            <NoiseBackground :opacity="0.35" rounded="default">
                <div class="p-6">
                    <h3 class="text-lg font-black">带噪点背景的内容</h3>
                    <p class="text-sm opacity-70">噪点纹理为设计增添质感。</p>
                </div>
            </NoiseBackground>
        </div>
