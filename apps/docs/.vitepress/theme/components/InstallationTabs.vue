...
const componentImports: Record<string, string[]> = {
    ...
    'alert-dialog': ['AlertDialog', 'AlertDialogTrigger', 'AlertDialogContent', 'AlertDialogHeader', 'AlertDialogFooter', 'AlertDialogTitle', 'AlertDialogDescription', 'AlertDialogAction', 'AlertDialogCancel', 'buttonVariants'],
    ...
    combobox: ['Combobox', 'ComboboxMulti', 'buttonVariants', 'PopoverContent', 'Command', 'CommandInput', 'CommandList', 'CommandEmpty', 'CommandGroup', 'CommandItem'],
    'scroll-area': ['ScrollArea', 'ScrollBar'],
    'submit-button': ['SubmitButton', 'buttonVariants'],
    form: ['Form', 'FormField', 'FormItem', 'FormLabel', 'FormControl', 'FormDescription', 'FormMessage', 'Label'],
    sheet: ['Sheet', 'SheetTrigger', 'SheetContent', 'SheetHeader', 'SheetFooter', 'SheetTitle', 'SheetDescription', 'SheetClose'],
    slider: ['Slider'],
    toggle: ['Toggle'],
    'toggle-group': ['ToggleGroup', 'ToggleGroupItem', 'toggleVariants', 'toggleGroupKey'],
    'radio-group': ['RadioGroup', 'RadioGroupItem'],
    progress: ['Progress'],
    'saas-pricing': ['SaaSPricing', 'Button', 'Card', 'CardHeader', 'CardTitle', 'CardDescription', 'CardContent', 'CardFooter', 'Badge'],
    'dashboard-stats': ['DashboardStats', 'Card', 'CardHeader', 'CardContent', 'CardDescription', 'Badge'],
    'brutalist-hero': ['BrutalistHero', 'Button', 'Card', 'CardContent'],
    'pricing-section': ['PricingSection', 'Button', 'Card', 'CardHeader', 'CardTitle', 'CardDescription', 'CardContent', 'CardFooter', 'Badge'],
    'auth-card': ['AuthCard', 'Button', 'Card', 'CardHeader', 'CardTitle', 'CardDescription', 'CardContent', 'CardFooter', 'Input', 'Label'],
    'dashboard-shell': ['DashboardShell'],
    'empty-state': ['EmptyState', 'Button'],
    'waitlist-page': ['WaitlistPage', 'Button', 'Input'],
}
